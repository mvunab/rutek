...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex">
      {/* Left — Branding */}
      <div className="hidden lg:flex flex-col justify-between w-[420px] flex-shrink-0 bg-white border-r border-stone-200 p-10">
        <div>
          <div className="flex items-center gap-3 mb-12">
            ...
            <div>
              <p className="text-lg font-bold text-stone-900">Rutek</p>
              <p className="text-xs text-stone-400">Logistics SaaS</p>
            </div>
          </div>
          ...
          {/* Decorative */}
          <div className="mt-10 p-4 bg-stone-50 border border-stone-200 rounded-xl">
            <div className="flex items-center gap-2 mb-3">
              <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-xs font-semibold text-stone-600">Sistema operativo</span>
            </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-stone-900 mb-1">Iniciar sesión</h2>
          <p className="text-sm text-stone-500 mb-8">Accede a tu plataforma de logística</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-stone-50 border border-stone-300 rounded-lg px-3 py-2.5 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent shadow-sm"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-stone-50 border border-stone-300 rounded-lg px-3 py-2.5 pr-10 text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent shadow-sm"
                  placeholder="••••••••"
                  required
                />
                <button
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-xs text-stone-400 font-medium">Cuentas demo</p>
              <div className="flex-1 h-px bg-stone-200" />
            </div>
