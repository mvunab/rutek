...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-white hover:bg-stone-50 text-stone-700 border border-stone-300 shadow-sm disabled:opacity-50',
  ghost: 'hover:bg-stone-100 text-stone-600 hover:text-stone-900 disabled:text-stone-300',
  danger: 'bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 disabled:opacity-50',
  success: 'bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 disabled:opacity-50',
};
